# Generated by Django 3.1.4 on 2022-12-08 19:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_nota', models.CharField(max_length=255, unique=True, verbose_name='N. da nota de empenho')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_conclusao', models.DateField(blank=True, null=True, verbose_name='Data prevista de conclusão')),
                ('dt_inclusao', models.DateTimeField(auto_now_add=True, verbose_name='Dt. Inclusão')),
                ('cadastrado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
